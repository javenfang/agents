...
> ## 🎯 个人定制版本
> 
> 这是一个 **精选版本**，基于原始的 76 个 agents 集合，仅保留了 **29 个常用 agents**。
> 
> ### 筛选重点：
> - ✅ **全栈开发**：前端、后端、移动端、数据库
> - ✅ **主流语言**：JavaScript、TypeScript、Flutter、iOS、SQL
> - ✅ **工程实践**：代码审查、测试、调试、文档
> - ✅ **DevOps**：部署、运维、数据库优化
> - ✅ **AI/数据**：LLM 应用、数据工程、提示词工程
> 
> ### 🇨🇳 中文用户使用指南：
> 将 `chinese_keywords_improved/` 目录下的 agent 定义文件复制到 `.claude/agents/` 目录：
> ```bash
> cp chinese_keywords_improved/*.md ~/.claude/agents/
> ```
> 
> **为什么要这样做？**
> - 原版 agent 定义仅包含英文关键词，中文查询时可能无法准确触发
> - 优化版在描述中嵌入了中文关键词（如"后端架构"、"前端开发"等）
> - 使用中文描述任务时，Claude 能更准确地识别并调用对应的专业 agent
> 
> ### 查看筛选详情：
> 👉 查看 [`MY_AGENTS.md`](MY_AGENTS.md) 了解具体保留了哪些 agents
> 
> ---
